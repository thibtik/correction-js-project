...
// dom_choiceA.addEventListener('click',answerA);
// dom_choiceB.addEventListener('click',answerB);
// dom_choiceC.addEventListener('click',answerC)
// dom_choiceD.addEventListener('click',answerD)